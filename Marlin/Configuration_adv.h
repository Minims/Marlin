...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { -62.0, 320.0 }, { -62.0, -10.0 }, { 155.0, 370.0 } }
  #else
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN          PE2 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 */
  ...
  //#define MMU2_MENUS
  #if EITHER(MMU2_MENUS, HAS_PRUSA_MMU2)
