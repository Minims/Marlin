...
#define CUSTOM_MACHINE_NAME "JustIN"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3Dv6 Clone 40w & Silicone @240°C
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //12v MK2a PCB Heatbed (covered with 3mm Aluminium plate)
  //#define  DEFAULT_bedKp 155.95
  //#define  DEFAULT_bedKi 17.00
  //#define  DEFAULT_bedKd 357.72
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 197.74 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 75, 10000 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  //#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - (MIN_PROBE_EDGE))  //185
  //#define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE                   //20
  //#define BACK_PROBE_BED_POSITION (Y_BED_SIZE - (MIN_PROBE_EDGE))   //165
